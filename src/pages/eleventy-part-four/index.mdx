---
title: Let's Learn Eleventy (11ty) - Part IV - Images
date: 2021-01-23
...
<picture>
  ...
  <source 
    type="image/webp"
    srcset="/img/dog_large.webp  1280w, 
            /img/dog_medium.webp  640w,
            /img/dog_small.webp   320w"
    sizes="(min-width: 640px) 50vw, 100vw">  
  <source 
    type="image/jpg"
    srcset="/img/dog_large.jpg  1280w, 
...
<Picture src={import('./halfscreen.png')}
        widths={[480, 800]} 
...
<Picture src={import('./fullscreen.png')}
        widths={[480, 800]} 
        sizes="(max-width: 600px) 480px, 800px" 
        alt= "Mobile version"/>
...
```
The *metadata* object contains information about each image that was generated.
...
that shows only a part of the original. Sometimes people do something like this, some use a completely different image. This is called *art direction*.

<Picture src={import('./detail.jpg')}
        widths={[480, 800]} 
        sizes="(max-width: 600px) 480px, 800px" 
...
```Markdown
{% image "./src/images/dog.jpg", "My pug, Bobby", "(min-width: 640px) 50vw, 100vw", "", "./src/images/dogdetail.png", "(max-width: 480px)", "100vw" %}
```
