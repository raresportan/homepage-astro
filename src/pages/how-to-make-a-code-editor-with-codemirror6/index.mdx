...
<Picture src={import('./codemirror6.png')}
        widths={[480, 800]} 
        formats={["webp"]}
...
<Picture src={import('./codemirror6_html.png')}
        widths={[480, 800]} 
        formats={["webp"]}
        sizes="(max-width: 600px) 480px, 800px" 
...
```
<Picture src={import('./codemirror6_darktheme.png')}
        widths={[480, 800]} 
        formats={["webp"]}
        sizes="(max-width: 600px) 480px, 800px" 
...
<Picture src={import('./editor_in_action.png')}
        widths={[480, 800]} 
        formats={["webp"]}
        sizes="(max-width: 600px) 480px, 800px" 
