...
In my opinion, no code needs a great AI. *No code is just a collection of preexisting components(standalone pieces of software) combined in a certain way.*
...
*Imagine you're one of the Mars colonists, and you need a piece of software that is unique to your needs there - something that nobody on Earth thought about - 
and of course there are no programmers on Mars. Your only chance is a no code software created by an AI.* 
...
<Picture src={import('./quartz.jpeg')}
        widths={[480, 800]} 
        formats={["webp"]}
        sizes="(max-width: 600px) 480px, 800px" 
        alt= "Quartz Composer" />
