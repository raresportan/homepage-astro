...
Interestingly, Eleventy has __strong support__ for JavaScript at __build time__: templates, plugins, filters, shortcodes, data loaders, and so on.
...
Note that this option is complex and __is not documented anywhere__, but I've seen it used on some Eleventy starters.
